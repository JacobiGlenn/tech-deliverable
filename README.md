...
Application for Tech Team in the Hack @ UCI Club | RUN INSTRUCTIONS: I made this to run locally so you need to do "npm run dev" in a backend terminal and then "python main.py" in a frontend terminal. Once you do that opent the local host link. Please enjoy my application, thank you!
